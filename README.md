...
```
sudo apt update && sudo apt install -y git && git clone https://github.com/harrissondutra/portainer-sistudo.git && cd portainer-sistudo && sudo chmod +x install.sh && ./install.sh
```
